...
| review.md | 七类审查细则与 PASS/FAIL 判定 |
...
| cumcm.md | 数学建模竞赛论文：篇幅、摘要一页、图配置、通用框架、SOTA 对比、AI 使用披露、加黑预算、附录代码规范 |
| patent.md | 专利文件：说明书摘要/权利要求书/说明书结构与篇幅、权利要求支持、权利要求规范性五查、术语统一、易混词区分、六轮迭代审查工作流 |
| consistency.md | 编号漂移、附录代码完整性、页数配平、字体缺字：三层编号核查的做法与真实案例 |
| polish.md | 成稿多轮精改复核：版本 diff 驱动复核、外部意见采纳判定、精改报告格式、定性表述自洽、跨文档口径、加黑治理、佐证材料专项 |
...
- polish-report-template.md：精改报告模板，含分级清单、批量替换表、请核对清单、不要动清单与验收清单。
